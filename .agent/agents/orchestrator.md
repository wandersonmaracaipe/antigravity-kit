...
model: inherit
skills: clean-code, parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, context-engineering, uncertainty-calibration, evaluation-science, prompt-optimization, lint-and-validate, powershell-windows, bash-linux
---
